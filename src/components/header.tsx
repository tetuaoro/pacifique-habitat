    ...
    <header className="container-fluid">
      <nav>
        ...
        <ul className={`menu ${menu && "active"}`}>
          ...
          <Li href="/secteur" linkName="Secteurs d'activité" onClick={closeMenu} />

          <Li onClick={closeMenu} className="list active" href="/services/resine" linkName="Applicateur de résine" />
          <Li onClick={closeMenu} className="list active" href="/services/piscine" linkName="Piscine" />
          <Li onClick={closeMenu} className="list active" href="/services/conception" linkName="Conception, étude et plans" />
          <Li onClick={closeMenu} className="list active" href="/services/construction" linkName="Construction" />
          ...
          <li className="contact active">
            {contacts.map((element, k) => (
              <Fragment key={k}>{element}</Fragment>
            ))}
          </li>
        </ul>
